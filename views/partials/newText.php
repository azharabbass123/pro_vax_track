          ...
          <div class="row">
            <div class="col-lg-3">
              <ul class="nav nav-tabs flex-column" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="nav-link active show" data-bs-toggle="tab" href="#departments-tab-1" aria-selected="true" role="tab">Cardiology</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#departments-tab-2" aria-selected="false" tabindex="-1" role="tab">Neurology</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#departments-tab-3" aria-selected="false" tabindex="-1" role="tab">Hepatology</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#departments-tab-4" aria-selected="false" tabindex="-1" role="tab">Pediatrics</a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="col-lg-9 mt-4 mt-lg-0">
              <div class="tab-content">
                <div class="tab-pane active show" id="departments-tab-1" role="tabpanel">
                  <div class="row">
                ...
                <div class="tab-pane" id="departments-tab-4" role="tabpanel">
                  <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-7 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-f6fdb102553a57a6" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-2564px, 0px, 0px); transition-delay: 0ms;">
                ...
                <div class="swiper-slide swiper-slide-next" role="group" aria-label="4 / 5" data-swiper-slide-index="3">
                  ...
                  </div><div class="swiper-slide" role="group" aria-label="5 / 5" data-swiper-slide-index="4">
                    <div class="testimonial-item">
                      <div class="d-flex">
                  ...
                  </div><div class="swiper-slide" role="group" aria-label="1 / 5" data-swiper-slide-index="0">
                    <div class="testimonial-item">
                      <div class="d-flex">
                  ...
                  </div><div class="swiper-slide swiper-slide-prev" role="group" aria-label="2 / 5" data-swiper-slide-index="1">
                    <div class="testimonial-item">
                      <div class="d-flex">
                  ...
                  </div><div class="swiper-slide swiper-slide-active" role="group" aria-label="3 / 5" data-swiper-slide-index="2">
                    <div class="testimonial-item">
                      <div class="d-flex">
